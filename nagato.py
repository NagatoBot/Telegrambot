...
# ==========================================
# TEMPLATES (CYBERPUNK NEON GLOW THEME)
# ==========================================
...
<head>
    ...
    <style>
        ...
        .glass-card {
            background: linear-gradient(135deg, rgba(22, 12, 42, 0.8) 0%, rgba(13, 8, 25, 0.9) 100%);
...
<body class="text-slate-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    <!-- Ambient Neon Lights -->
    <div class="fixed top-[-10%] left-[-5%] w-[45vw] h-[45vw] bg-fuchsia-600/15 rounded-full blur-[130px] pointer-events-none"></div>
    <div class="fixed bottom-[-10%] right-[-5%] w-[45vw] h-[45vw] bg-cyan-500/15 rounded-full blur-[140px] pointer-events-none"></div>

    <div class="w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-fuchsia-600 to-cyan-400 p-[1px] mb-3 shadow-lg shadow-fuchsia-500/25">
                <div class="w-full h-full bg-[#0d0819] rounded-[15px] flex items-center justify-center font-tech text-cyan-300 text-xl">
                    &#9889;
                </div>
            </div>
            <h1 class="font-tech text-2xl font-extrabold tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-400 via-purple-300 to-cyan-400">
                NAGATO PANEL
            </h1>
            <p class="text-xs text-purple-400/80 mt-1 font-mono uppercase tracking-wider">Cyberpunk Security &bull; Access Core</p>
        </div>

        <div class="glass-card rounded-2xl p-7 shadow-2xl space-y-4">
            {% if error %}
            ...
            <form method="POST" action="/login" class="space-y-4">
                <div>
                    <label class="block text-xs font-semibold text-purple-300 uppercase tracking-wider mb-2 font-mono">Username</label>
                    <input type="text" name="username" required autofocus placeholder="admin"
                           class="w-full bg-[#070410]/90 border border-purple-900/60 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(0,240,255,0.25)] transition">
                </div>

                <div>
                    <label class="block text-xs font-semibold text-purple-300 uppercase tracking-wider mb-2 font-mono">Password</label>
                    <input type="password" name="password" required placeholder="********"
                           class="w-full bg-[#070410]/90 border border-purple-900/60 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-fuchsia-500 focus:shadow-[0_0_15px_rgba(255,0,127,0.25)] transition">
                </div>

                <button type="submit"
                        class="w-full mt-2 bg-gradient-to-r from-fuchsia-600 via-purple-600 to-cyan-600 hover:from-fuchsia-500 hover:to-cyan-500 text-white font-tech font-bold py-2.5 rounded-xl shadow-lg shadow-fuchsia-600/30 tracking-wider text-xs uppercase transition">
                    Authenticate &rarr;
                </button>
            </form>

            <div class="pt-3 border-t border-purple-900/40 text-center">
                <a href="https://t.me/NAGATOxOWNER" target="_blank" rel="noopener noreferrer"
                   class="inline-flex items-center justify-center gap-1.5 text-xs text-cyan-400 hover:text-cyan-300 font-mono transition py-1">
        ...
        <p class="text-center text-purple-400/60 text-xs mt-6 font-mono">&copy; Nagato Panel &bull; Cyberpunk Core</p>
    </div>
</body>
</html>"""
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2.5">
                    ...
                    <span class="font-tech font-bold text-sm text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-cyan-300 tracking-wider">Nagato Panel</span>
                </div>
