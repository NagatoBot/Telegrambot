...
# ==========================================
# TEMPLATES (RESTYLED RESET MODAL + ORDER ACTION CONTROLS)
# ==========================================
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <form method="POST" action="/admin/save">
                ...
                <div id="tab-media" class="tab-content space-y-5 hidden">
                    ...
                    <!-- Direct Video File Upload (Full-Width Responsive Layout) -->
                    <div class="glass-card rounded-2xl p-5 space-y-3">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                            <label class="flex-1 cursor-pointer">
                                <input type="file" id="demo_file_input" accept="video/mp4,video/*" 
    ...
    <script>
        ...
        async function uploadDemoVideoFile() {
            ...
            if (!input.files || input.files.length === 0) {
                statusEl.innerText = "⚠️ Please select a video file first.";
            ...
            statusEl.innerText = "⏳ Uploading (" + (file.size / (1024 * 1024)).toFixed(1) + " MB)... Please wait.";
            ...
            try {
                ...
                if (res.ok && data.status === 'success') {
                    statusEl.innerText = "✅ Video uploaded and saved to playlist!";
