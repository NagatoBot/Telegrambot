...
# ==========================================
# DASHBOARD TEMPLATE WITH DESIGNED DELETE MODAL
# ==========================================
...
<body class="text-slate-100 min-h-screen flex">
    ...
    <!-- Designed In-Page Cyberpunk Delete Modal -->
    <div id="confirmDeleteModal">
        <div class="glass-card max-w-sm w-full p-6 rounded-2xl border border-rose-500/40 shadow-[0_0_30px_rgba(244,63,94,0.25)] space-y-5 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <table class="w-full text-left text-xs font-mono text-slate-300 border-collapse">
                            ...
                            <tbody class="divide-y divide-purple-900/30">
                                ...
                                <tr class="hover:bg-purple-900/20 transition">
                                    ...
                                    <!-- Styled In-Page Modal Delete Trigger -->
                                    <td class="p-3 text-center align-middle">
    ...
    <script>
        ...
        // Custom Cyberpunk Delete Modal Handlers
...
# Cleaned redirect handler eliminating 500 header-encoding error
...
async def handle_user_ban_toggle(
    ...
    msg = urllib.parse.quote_plus(f"User {user_id} {action_text} successfully")
    return RedirectResponse(
        url=f"/?message={msg}&tab=tab-users",
        status_code=status.HTTP_303_SEE_OTHER,
    )
...
async def handle_user_subscription_change(
    ...
    msg = urllib.parse.quote_plus(f"User {user_id} subscription updated to {plan_name}")
    return RedirectResponse(
        url=f"/?message={msg}&tab=tab-users",
        status_code=status.HTTP_303_SEE_OTHER,
    )
