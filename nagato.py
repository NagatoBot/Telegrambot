...
<body class="text-slate-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            ...
            <p class="font-tech text-xs tracking-widest text-cyan-300 mt-1 uppercase">Pom Pom Bot</p>
            <p class="text-[11px] text-purple-400/80 mt-0.5 font-mono uppercase tracking-wider">Cyberpunk Security &bull; Access Core</p>
        </div>
